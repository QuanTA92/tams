...
const SubCRUD = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editing) {
        // Update subcategory
        await axiosInstance.put(`${apiBase}/update/${currentSubcategoryId}`, formData);
  ...
  return (
    <div style={styles.container}>
      <h1 className="text-2xl font-bold mb-4 text-center">Quản lý Danh Mục Con</h1>
        ...
        <div>
          ...
          <thead>
            <tr>
              ...
              <th style={{ ...styles.thTd, ...styles.th }}>Tên Danh Mục Con</th>
              ...
              <tr key={subcategory.idSubcategory}>
                ...
                <td style={styles.thTd}>
                  ...
                  <button
                    ...
                    onClick={() => handleDelete(subcategory.idSubcategory)}
                  >
                    Xóa
                  </button>
                </td>
